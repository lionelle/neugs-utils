## Students version of simple calculator. Has intentional errors in it. 
...
def get_client_input() -> Optional[Tuple[str, float, float]]:
    ...
    if len(input_list) != 3:
        print("Invalid input, please try again. Format should be : <function> <num1> <num2>", file=sys.stderr) ## ERROR in text
